    ...
    function postData(form) {
        form.addEventListener('submit', (e) => {
            ...
            statusMessage.style.cssText = `
                ...
                margin: 0 auto;
            `;
            // form.append(statusMessage); // не работает со второй формой, плющит её из-за верстки на флексах
            // form.insertAdjacentElement('afterend', statusMessage); // устаревший метод
