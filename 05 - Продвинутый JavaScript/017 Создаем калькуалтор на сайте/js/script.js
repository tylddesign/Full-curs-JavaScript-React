window.addEventListener('DOMContentLoaded', () => {
    ...
    let doc = document.querySelector('#gender div');
    console.log('doc');
    console.log(doc);

    let calculating__choose_big = document.querySelector('.calculating__choose_big div');
    console.log('calculating__choose_big');
    console.log(calculating__choose_big);
